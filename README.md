# Pagliacii's Personal Scoop Bucket
...
| [chatwise](https://chatwise.app/) | 0.9.56 | Fast AI Chatbot for any LLM |
| [cyme](https://github.com/tuna-f1sh/cyme) | 2.2.8 | List system USB buses and devices; a lib and modern cross-platform lsusb that attempts to maintain compatibility with, but also add new features |
...
| [kazumi](https://github.com/Predidit/Kazumi) | 1.8.9 | 基于自定义规则的番剧采集APP，支持流媒体在线观看，支持弹幕。 |
| [neovim-nightly](https://github.com/neovim/neovim) | v0.12.0-dev-1651 | Vim-fork focused on extensibility and usability |
| [opencode](https://github.com/sst/opencode) | 1.0.78 | An AI coding agent designed for the terminal |
<!-- APPS_TABLE_END -->
